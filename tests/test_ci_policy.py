...
""",
    ...
    assert plan.toolchain_version == "v0.5.1"
    assert plan.runtime_image == "ghcr.io/brainboxemb/scad-toolchain:v0.5.1"
...
def test_openscad_scons_presentation_project_plan(tmp_path: Path):
    ...
    assert plan.toolchain_version == "v0.5.1"
    assert plan.runtime_image == "ghcr.io/brainboxemb/scad-toolchain-openscad:v0.5.1"
